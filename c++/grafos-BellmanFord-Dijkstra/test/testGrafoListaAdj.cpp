...
#ifndef GRAFO_LISTA_ADJ_TEST_H
#define GRAFO_LISTA_ADJ_TEST_H
// #include "pch.h"
...
TEST_F(MenorCaminhoTest, BellmanFordGrafoComLacoNegativo) {
	...
	//como o grafo s� tem um componente
...
TEST_F(MenorCaminhoTest, BellmanFordGrafoCom2ComponentesECicloNegativo) {
	...
	//todos os v�rtices que s�o alcanc�veis a partir de v1
	...
	//infelizmente, o BellmanFord n�o retorna POS_INF
